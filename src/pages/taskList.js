...
const TaskTable = () => {
  ...
  useEffect(() => {
    dispatch(fetchTasks(page + 1, rowsPerPage)); // Fetch tasks for the current page
  }, [dispatch, page]);
              ...
              <Table className={classes.table}>
                ...
                <TableBody>
                  {tasks.map((task, index) => (
                    <TableRow key={task._id} className={index % 2 === 0 ? classes.evenRow : ''}>
                      ...
                      <TableCell style={{ border: '1px solid #ddd' }}>
                        ...
                        <IconButton color="primary" onClick={() => handleDelete(task._id)}>
                          <DeleteIcon />
                        </IconButton>
                      </TableCell>
                    </TableRow>
